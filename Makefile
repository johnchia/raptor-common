...
SRCS    := src/rss_log.c src/rss_config.c src/rss_daemon.c src/rss_util.c src/rss_ctrl_cmds.c src/rss_ctrl_client.c src/rss_http.c src/rss_shadow.c src/rss_ts.c src/rss_sei.c src/rss_sign.c src/rss_jpeg.c src/rss_aac.c src/rss_media_clock.c src/rss_vui.c src/cJSON.c \
